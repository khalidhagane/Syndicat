...
function Sidebar() {
    return (
        <div className="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bgsidebar h-full text-white transition-all duration-300 border-none z-10 sidebar">
